...
(total_cost_vax_b <- calc_vaccination_cost(pop, risk_group, vax_cost, vax_comp = 0))  # base
(total_cost_vax_i <- calc_vaccination_cost(pop, risk_group, vax_cost, vax_comp = 0.4))  # intv
