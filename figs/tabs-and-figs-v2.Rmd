...
g4 + aes(y = cases) + labs(y = "Cases", title = "Healthy People Vaccination (20% VE): Cases")
g4 + aes(y = cases.per100k) + labs(y = "Cases per 100k", title = "Healthy People Vaccination (20% VE): Cases per 100k")
g4 + aes(y = cases.averted) + labs(y = "Cases averted", title = "Healthy People Vaccination (20% VE): Cases averted")
g4 + aes(y = cases.averted.per100k) + labs(y = "Cases averted per 100k", title = "Healthy People Vaccination (20% VE): Cases averted per 100k")
```

## 20% VE: Deaths, deaths averted
```{r}
g4 + aes(y = deaths) + labs(y = "Deaths", title = "Healthy People Vaccination (20% VE): Deaths")
g4 + aes(y = deaths.per100k) + labs(y = "Deaths per 100k", title = "Healthy People Vaccination (20% VE): Deaths per 100k")
g4 + aes(y = deaths.averted) + labs(y = "Deaths averted", title = "Healthy People Vaccination (20% VE): Deaths averted")
g4 + aes(y = deaths.averted.per100k) + labs(y = "Deaths averted per 100k", title = "Healthy People Vaccination (20% VE): Deaths averted per 100k")
```

## 20% VE: DALYs, DALYs averted
```{r}
g4 + aes(y = dalys) + labs(y = "DALYs", title = "Healthy People Vaccination (20% VE): DALYs")
g4 + aes(y = dalys.per100k) + labs(y = "DALYs per 100k", title = "Healthy People Vaccination (20% VE): DALYs per 100k")
g4 + aes(y = dalys.averted) + labs(y = "DALYs averted", title = "Healthy People Vaccination (20% VE): DALYs averted")
g4 + aes(y = dalys.averted.per100k) + labs(y = "DALYs averted per 100k", title = "Healthy People Vaccination (20% VE): DALYs averted per 100k")
```
