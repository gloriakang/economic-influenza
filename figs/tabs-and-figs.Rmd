...
```{r}
t <- labs(y = "$ saved per case averted", title = "Base Vaccination: ICER per case averted")
...
ggplot(df_base[(df_base$v.eff == "40"),], aes(x = age, y = icer.case.averted, group = risk, color = risk)) +
  ...
  ylab("$ saved per case averted") + ggtitle("Base Vaccination (40% efficacy): ICER per case averted")
```

## Fig. ICER per death averted
```{r}
t <- labs(y = "$ saved per death averted", title = "Base Vaccination: ICER per death averted")
...
ggplot(df_base[(df_base$v.eff == "40"),], aes(x = age, y = icer.death.averted, group = risk, color = risk)) +
  geom_point() + geom_line(linetype = "dotted") + labs(x = "Age group", color = "Risk group") + 
  ylab("$ saved per death averted") + ggtitle("Base Vaccination (40% efficacy): ICER per death averted")
```

## Fig. ICER per DALY averted
```{r}
t <- labs(y = "$ saved per DALY averted", title = "Base Vaccination: ICER per DALY averted")
...
ggplot(df_base[(df_base$v.eff == "40"),], aes(x = age, y = icer.daly.averted, group = risk, color = risk)) +
  geom_point() + geom_line(linetype = "dotted") + labs(x = "Age group", color = "Risk group") + 
  ylab("$ saved per DALY averted") + ggtitle("Base Vaccination (40% efficacy): ICER per DALY averted")
```
...
```{r}
g4 + aes(y = cases) + labs(y = "Cases", title = "Base Vaccination (40% VE): Cases")
g4 + aes(y = cases.per100k) + labs(y = "Cases per 100k", title = "Base Vaccination (40% VE): Cases per 100k")
g4 + aes(y = cases.averted) + labs(y = "Cases averted", title = "Base Vaccination (40% VE): Cases averted")
g4 + aes(y = cases.averted.per100k) + labs(y = "Cases averted per 100k", title = "Base Vaccination (40% VE): Cases averted per 100k")
```
...
```{r}
g4 + aes(y = deaths) + labs(y = "Deaths", title = "Base Vaccination (40% VE): Deaths")
g4 + aes(y = deaths.per100k) + labs(y = "Deaths per 100k", title = "Base Vaccination (40% VE): Deaths per 100k")
g4 + aes(y = deaths.averted) + labs(y = "Deaths averted", title = "Base Vaccination (40% VE): Deaths averted")
g4 + aes(y = deaths.averted.per100k) + labs(y = "Deaths averted per 100k", title = "Base Vaccination (40% VE): Deaths averted per 100k")
```
...
```{r}
g4 + aes(y = dalys) + labs(y = "DALYs", title = "Base Vaccination (40% VE): DALYs")
g4 + aes(y = dalys.per100k) + labs(y = "DALYs per 100k", title = "Base Vaccination (40% VE): DALYs per 100k")
g4 + aes(y = dalys.averted) + labs(y = "DALYs averted", title = "Base Vaccination (40% VE): DALYs averted")
g4 + aes(y = dalys.averted.per100k) + labs(y = "DALYs averted per 100k", title = "Base Vaccination (40% VE): DALYs averted per 100k")
```
