...
##### Children low risk
Children.low.risk<-function(AR,vax.comp,tot.pop,totalpopulation,Children.case,case.after.vax){
  risk.group = 0.936
  high.risk.ch.ar=Children.case*risk.group
  #high.risk.ch.ar=base.case.catastrophic[1]*risk.group
  set.seed(1000)
  ...
  high.risk.ch.nonvax=case.after.vax*risk.group
...
Children.high.risk <- function(AR,vax.comp,tot.pop,totalpopulation,Children.case,case.after.vax){
...
adult.low.risk <- function(AR,vax.comp,tot.pop,totalpopulation,Children.case,case.after.vax){
...
adult.high.risk <- function(AR,vax.comp,tot.pop,totalpopulation,Children.case,case.after.vax){
...
senior.low.risk <- function(AR,vax.comp,tot.pop,totalpopulation,Children.case,case.after.vax){
  risk.group = 1-0.4  
  high.risk.ch.ar=Children.case*risk.group
...
senior.high.risk <- function(AR,vax.comp,tot.pop,totalpopulation,Children.case,case.after.vax){
  risk.group = 0.4
  high.risk.ch.ar=Children.case*risk.group
